...
class ReviewFileUseCase {
  ...
  ReviewFileUseCase({required this.repository});

  Future<List<ReviewFilesEntity>> call({required ArticleProcessParams params}) {
    return repository.getReviewFiles(params: params);
  }
}
